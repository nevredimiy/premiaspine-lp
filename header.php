...
<div class="wrapper sticky-header">
    <?php if ( is_page_template( array( 'landing_page.php', 'page-info.php' ) ) ) : ?>
                    ...
                    <div class="call-now-request">
                        <a href="tel:6463600936">
                            <div class="call-now-block">
                                <?php if ( ! empty( $options['header']['phone_title'] ) ) : ?>
                                <span><?php echo esc_html( $options['header']['phone_title'] ); ?></span>
                                <?php endif; ?>
