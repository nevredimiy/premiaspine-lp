    ...
    <div class="hero-doctor">
        ...
        <div class="holder" <?php if ($bg_url) : ?> style="background-image: url('<?php echo esc_url($bg_url); ?>');" <?php endif; ?>>
            <?php if ($title = premiaspine_landing_opt($doctor, array('title'))) : ?>
                <h1><?php echo premiaspine_landing_render_field_html($title); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                    ?></h1>
            <?php endif; ?>
            <?php
    ...
    <div class="hero-premia__patient patient-hero">
        ...
        <div class="patient-hero__body">
            <?php if ($hero_title = premiaspine_landing_opt($patient, array('title'))) : ?>
                <h2 class="patient-hero__title"><?php echo premiaspine_landing_render_editor_html($hero_title); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                                                ?></h2>
            <?php endif; ?>
            <?php if ($hero_name = premiaspine_landing_opt($patient, array('name'))) : ?>
                <div class="patient-hero__name"><?php echo premiaspine_landing_render_field_html($hero_name); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                                                ?></div>
            <?php endif; ?>
        </div>
        <?php if ($youtube) : ?>
